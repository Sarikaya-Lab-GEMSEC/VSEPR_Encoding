...
def cross_val(args):
    ...
    allele_list_9 = ['HLA-A*02:01', 'HLA-A*03:01', 'HLA-A*11:01', 'HLA-A*02:03', 'HLA-B*15:01', 'HLA-A*31:01',
                     'HLA-A*01:01', 'HLA-B*07:02', 'HLA-A*26:01', 'HLA-A*02:06', 'HLA-A*68:02', 'HLA-B*08:01',
                     'HLA-B*58:01', 'HLA-B*40:01', 'HLA-B*27:05', 'HLA-A*30:01', 'HLA-A*69:01', 'HLA-B*57:01',
                     'HLA-B*35:01', 'HLA-A*02:02', 'HLA-A*24:02', 'HLA-B*18:01', 'HLA-B*51:01', 'HLA-A*29:02',
                     'HLA-A*68:01', 'HLA-A*33:01', 'HLA-A*23:01']

    allele_list_10 = ['HLA-A*02:01', 'HLA-A*03:01', 'HLA-A*11:01', 'HLA-A*68:01', 'HLA-A*31:01', 'HLA-A*02:06',
                      'HLA-A*68:02', 'HLA-A*02:03', 'HLA-A*33:01', 'HLA-A*02:02']
    ...
    for length in [10, 9]:
        ...
        for allele in allele_list:  # [9,10]
            ...
            data_dict = pickle.load(open(
                args.data_dir + os.sep + 'pickle_' + str(length) + os.sep + allele.replace('*', '.').replace(':',
                                                                                                             '_') + '.p',
                'rb'))
            ...
            if (len(sequ) > 5):
                ...
                for fold_num in range(1, 6):
                    ...
                    best_model_dict = torch.load(
                        model_dir + os.sep + allele + '_' + str(length) + '_' + str(fold_num) + '.pth')
                ...
                srcc = spearmanr(output_list, label_list)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--testFile', default='testFile_Pic50.txt')
    parser.add_argument('--predict', default='testPredict_Pic50.txt')
