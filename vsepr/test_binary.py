...
def cross_val(args):
    ...
    for length in [10, 9]:
        ...
        for allele in allele_list:   #[9,10]
            ...
            data_dict = pickle.load(open(args.data_dir + os.sep + 'pickle_' + str(length) + '_binary'+ os.sep + allele.replace('*','.').replace(':','_')+'.p', 'rb'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--testFile', default='testFile_binary.txt')
    parser.add_argument('--predict', default='testPredict_binary.txt')
